...
3. **❓ Question — à l'inscription (`/demarrer`), l'admin créé n'est pas explicitement "Owner".** Toujours en attente d'arbitrage — dépend du Module 5 (rôles workspace), pas construit.
4. **⚠️ Demande — choix de plan manquant à l'inscription.** Toujours en attente — pas traité dans ce lot.
